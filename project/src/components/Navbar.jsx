  ...
  const navLinkClass = ({ isActive }) =>
    `px-4 py-2 rounded-lg transition-all duration-300 ${
      isActive
        ...
        : "text-slate-800 md:text-slate-100 hover:bg-slate-600 hover:text-white"
    }`;
    ...
    <nav className="sticky top-0 z-50 bg-slate-700 text-white shadow-lg">
      <div className="max-w-7xl mx-auto px-5 lg:px-8 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4 lg:gap-6 font-medium">
          ...
          <NavLink to="/polycet" className={navLinkClass}>
            POLYCET
          </NavLink>

          <NavLink to="/diploma" className={navLinkClass}>
            Diploma
          </NavLink>
        ...
        <div className="hidden md:flex items-center">
          {authenticated ? (
            <div className="flex items-center gap-2 bg-slate-800 px-4 py-2 rounded-lg shadow max-w-xs">
              <CgProfile size={20} />
            ...
            <Link
              to="/signin"
              className="flex items-center gap-2 bg-slate-900 px-4 py-2 rounded-lg font-semibold shadow hover:bg-slate-800 transition"
            >
              <CgProfile size={20} />
              Sign In
            </Link>
      ...
      >
        <div className="flex flex-col px-5 gap-3 font-medium">
          ...
          {!authenticated && (
            <Link
              to="/signin"
              onClick={() => setMenuOpen(false)}
              className="bg-slate-900 text-white text-center rounded-lg py-3 font-semibold hover:bg-slate-800 transition"
            >
              Sign In
            </Link>
          )}
