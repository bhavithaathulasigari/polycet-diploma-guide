...
const ChemistrySyllabus = () => {
  ...
  const handleDownload = () => {
    if (!isAuthenticated()) {
      ...
      link.href = "/public/pdfs/Chemistry.pdf"; // replace with actual PDF
      link.download = "Chemistry_Syllabus.pdf";
      link.click();
    }
  };
  ...
  return (
    <div className="min-h-screen p-8 bg-gray-50">
      <h2 className="text-3xl font-bold mb-6 text-center">Chemistry Syllabus</h2>
      <ul className="list-disc list-inside max-w-3xl mx-auto bg-white p-6 rounded-xl shadow">
        <li>Physical Chemistry</li>
        <li>Organic Chemistry</li>
        <li>Inorganic Chemistry</li>
        <li>Chemical Bonding</li>
        <li>Solutions & Electrochemistry</li>
